...
var clipboardTitle = "Pandas";
var clipboardText = "Etza is a pandita";
...
fetch("https://codeyourfuture.herokuapp.com/api/clipboard?title=Pandas")
  .then(function(response) {
    return response.text();
  })
  .then(text => {
    return (document.querySelector("#greeting-text").textContent = text);
  });
